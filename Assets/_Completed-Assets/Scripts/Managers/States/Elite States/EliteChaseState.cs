...
namespace Complete
{
public class EliteChaseState : State
{
    public EliteAttackState attackState;
    public EliteIdleState idleState;
    ...
    public override State RunCurrentState(int m_TypeMob, Transform PlayerLocation, GameObject m_Instance, Transform m_MobSpawner, Transform m_MobGoTo, bool oneTankLeft) 
    {
        ...
        {
            float distance_mob_desired_place = distance_player_mob - 15f;
            ...
            if (distance_player_mob <= 15f + 0.1f &&  distance_player_mob >= 15f - 0.1f)
            {
